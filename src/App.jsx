...
const TYPE_META = {
  ...
  snippet: {
    ...
    placeholder: "Paste a code or text snippet…",
  },
};
  ...
  return (
    <div className="app">
          ...
          <div className="empty-state">
            {query ? (
              ...
              <>
                ...
                <p className="empty-title">Your Brain is empty</p>
                <p className="empty-sub">
                  Start capturing notes, ideas, links, and snippets above
                </p>
              </>
            )}
          </div>
      ...
      <footer className="credit">
        Coded by{" "}
        <a
          href="https://www.instagram.com/overclocked_dev"
          target="_blank"
  ...
  return (
    ...
    >
      ...
      <div className="card-main">
        <div
          className={`card-content${item.type === "snippet" ? " mono" : ""}`}
        >
          {item.content}
        </div>
        {item.url && (
